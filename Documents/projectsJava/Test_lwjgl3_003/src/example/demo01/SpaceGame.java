...
import static example.demo01.WavefrontMeshLoader.*;
import static example.demo01.DemoUtils.*;
...
public class SpaceGame {
    ...
    private void createShip() throws IOException {
        ...
        ship = loader.loadMesh("demo01/ship.obj.zip");
    ...
    private void createAsteroid() throws IOException {
        WavefrontMeshLoader loader = new WavefrontMeshLoader();
        asteroid = loader.loadMesh("demo01/asteroid.obj.zip");
    ...
    private void createSphere() throws IOException {
        WavefrontMeshLoader loader = new WavefrontMeshLoader();
        sphere = loader.loadMesh("demo01/sphere.obj.zip");
    }
    ...
    private void createCubemapProgram() throws IOException {
        int vshader = createShader("demo01/cubemap.vs", GL_VERTEX_SHADER);
        int fshader = createShader("demo01/cubemap.fs", GL_FRAGMENT_SHADER);
    ...
    private void createShipProgram() throws IOException {
        int vshader = createShader("demo01/ship.vs", GL_VERTEX_SHADER);
        int fshader = createShader("demo01/ship.fs", GL_FRAGMENT_SHADER);
        int program = createProgram(vshader, fshader);
        glUseProgram(program);
    ...
    private void createParticleProgram() throws IOException {
        int vshader = createShader("demo01/particle.vs", GL_VERTEX_SHADER);
        int fshader = createShader("demo01/particle.fs", GL_FRAGMENT_SHADER);
        int program = createProgram(vshader, fshader);
        glUseProgram(program);
    ...
    private void createShotProgram() throws IOException {
        int vshader = createShader("demo01/shot.vs", GL_VERTEX_SHADER);
        int fshader = createShader("demo01/shot.fs", GL_FRAGMENT_SHADER);
        int program = createProgram(vshader, fshader);
        glUseProgram(program);
    ...
    private void createCubemapTexture() throws IOException {
        ...
        for (int i = 0; i < 6; i++) {
            imageBuffer = ioResourceToByteBuffer("demo01/space_" + names[i] + (i + 1) + ".jpg", 8 * 1024);
