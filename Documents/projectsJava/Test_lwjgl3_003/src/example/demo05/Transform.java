...
public class Transform {
	...
	Matrix4f translationMatrix = new Matrix4f().translated(translation);
	...
	Matrix4f cameraTranslation = new Matrix4f().translated(new Vector3f(-camera.getPos().x, -camera.getPos().y, -camera.getPos().z));
    ...
    public static void setProjection(float fov, int width, int height, float zNear, float zFar) {
	Transform.fov = fov;
