...
/*
    ...
    /**
     * Конструктор клавиатуры и мыши
     * @param window указываем окно на котором будем обрабатывать действия мыши и клавиатуры
     */
    ...
    public boolean isMouseDown(int mouseBottom) {
        return glfwGetMouseButton(window, mouseBottom) == 1;
    }
    ...
    public boolean isMousePressed(int mouseBottom) {
        return isMouseDown(mouseBottom) && !mouseButtons[mouseBottom];
    }
    
    public boolean isMouseReleased(int mouseBottom) {
        return !isMouseDown(mouseBottom) && mouseButtons[mouseBottom];        
    }
